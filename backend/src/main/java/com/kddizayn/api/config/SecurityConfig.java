...
import com.kddizayn.api.security.JwtAuthenticationFilter;
import com.kddizayn.api.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/v1/contact/admin").hasRole("ADMIN")
